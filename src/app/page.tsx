...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col lg:gap-8 grow items-start p-2 sm:p-10 pt-8">
      <div className="font-montserrat flex flex-col lg:grid lg:grid-cols-6 lg:grid-rows-3 gap-4 flex-1  lg:gap-8  w-full h-240 lg:h-auto">
